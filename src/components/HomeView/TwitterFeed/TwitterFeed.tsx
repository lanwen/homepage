...
export default class TwitterFeed extends React.Component<{}, {}> {
  ...
  render() {
    ...
    const data = [{
      ...
      content: 'Like all the cool kids in 2017, working on an app using GraphQL and backend built on @graphcool and it\'s all super cool so far #graphql',
      ...
      content: '@graphcool thank you so much! I just remade my app backend in 20 minutes on the kitchen counter! Took me much thinking without your coolness',
      author: 'emil møller',
      date: '28. Okt 2016',
