...
export const persons: Person[] = [{
  ...
  image: require('../../../assets/graphics/team/johannes.jpg'),
  links: {
  ...
  image: require('../../../assets/graphics/team/soren.jpg'),
  links: {
  ...
  image: require('../../../assets/graphics/team/tim.jpg'),
  links: {
  ...
  image: require('../../../assets/graphics/team/nilan.jpg'),
  links: {
