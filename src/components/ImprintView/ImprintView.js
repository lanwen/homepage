    ...
    return (
      <div className={classes.root}>
        ...
        <p>
          ...
          Further usage, also in parts, requires the approval by graph.cool.
        </p>
        <h3>Disclaimer</h3>
        <p>
          graph.cool does not assume any liability for the type
          or correctness of the material available on the graph.cool website.
        ...
        <p>
          This website makes use of Google Analytics.
          Therefore, anonymous usage statistics are collected.
          Data entered into the website is exclusively used for
          the indicated purposes and not transmitted to 3rd parties.
        </p>
      </div>
    )
  }
