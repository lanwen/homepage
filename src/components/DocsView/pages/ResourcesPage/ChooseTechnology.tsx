      ...
      <div className={cx($p.pb16, $p.mb60)}>
        ...
        <div>
          ...
          <div className={cx($p.flex, $p.flexWrap, $p.justifyCenter, $p.pv60)}>
            <img
              src={require('../../../../assets/graphics/ResourcesOverview/angular-icon.svg')}
              height={90}
              width={90}
              className={cx($p.ma25)}
            />
            <img
              src={require('../../../../assets/graphics/ResourcesOverview/apollostack.svg')}
              height={90}
              width={90}
              className={cx($p.ma25)}
            />
            <img
              src={require('../../../../assets/graphics/ResourcesOverview/react.svg')}
              height={90}
              width={90}
              className={cx($p.ma25)}
            />
            <img
              src={require('../../../../assets/graphics/ResourcesOverview/vue.svg')}
              height={90}
              width={90}
              className={cx($p.ma25)}
            />
            <img
              src={require('../../../../assets/graphics/ResourcesOverview/relay.svg')}
              height={90}
              width={90}
              className={cx($p.ma25)}
            />
