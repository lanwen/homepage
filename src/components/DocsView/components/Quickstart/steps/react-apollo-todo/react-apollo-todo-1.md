...
Using the [Graphcool CLI](https://www.npmjs.com/package/graphcool), you simply provide a data model and the GraphQL API will be generated for you. We already included the required [schema](https://github.com/graphcool-examples/react-apollo-todo-example/blob/master/todo.schema) in the GitHub repo, here is what it looks like:
...
cd react react-apollo-todo-example
