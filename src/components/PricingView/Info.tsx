              ...
              <div className={cx($p.flex)}>
                ...
                <div className={cx($p.flex, $p.flexColumn, $p.mh25)}>
                  ...
                  <div className={cx($p.white80, $p.f14, $p.mt10)}>
                    Graphcool has an integrated file management system. Easily store and display your users profile pictures, attachments or any other files.
                    Basic usage is free and for more demanding projects you are billed in increments of 50¢ / GB / month for additional storage and file transfer.
                  </div>
                </div>
