...
export default class OperationOverview extends React.Component<{}, State> {
  ...
  render() {
    const totalOperations = roundedStep(this.state.leftValue1) * roundedStep(this.state.rightValue1)
      + roundedStep(this.state.leftValue2) * roundedStep(this.state.rightValue2)
      + roundedStep(this.state.leftValue3) * roundedStep(this.state.rightValue3)
