      ...
      <div>
        ...
        <section className={cx($p.flex, $p.flexColumn, $p.flexWrap, $p.itemsCenter)}>
          {//tslint:disable-next-line
            <h1 className={cx($p.tc, $p.pv60)}>We provide a simple and flexible pricing model. <br/>We also have a free plan.
            </h1>
          }
        </section>
        <PricingViewTable />
        <section className={cx($p.black80, $p.o50, $p.bgBlack04, $p.pv60)}>
          <article className={cx($p.flex, $p.flexColumn, $p.flexWrap, $p.itemsCenter, $p.ph60)}>
            ...
            {//tslint:disable-next-line
              <PricingText
                className={cx($p.tc, $p.pb16)}>We structure our plans by number of users, requests and data.</PricingText>
            }
